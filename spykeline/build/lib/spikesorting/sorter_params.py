...
sorter_dict = {
    'ironclust' : "ironclust_output",
    
    'klusta' : "klusta_output",
    ...
    'kilosort2_5' : {'surname' : "KS25",
                     ...
                     'exctractor' : se.KiloSortSortingExtractor,
                     'path' : 'sorter_output'
                     },
    ...
    'kilosort4' : {'surname' : "KS4",
                   ...
                   'params' : {
                               ...
                               'do_correction' : False, # Wheither or not to perform drift correction
                               'skip_kilosort_preprocessing': True, # oppposite of do_CAR 
                               },
                   'exctractor' : se.KiloSortSortingExtractor,
                    'path' : 'sorter_output'
                   },
    ...
    'mountainsort4' : {'surname' : "MS4",
                       ...
                       'exctractor' : si.read_npz_sorting # se.MdaSortingExtractor
                       },
    ...
    'mountainsort5' : {'surname' : "MS5",
                       ...
                       'params' : {
                            ...
                            'detect_channel_radius': None, # the length around the channel with highest waveform amp to apply detect_time_radius_msec (None = applied infinitly so all channel are bloked -> bad; except if sorted by group)
                            'snippet_T1': 20, # before the spike 
                            'snippet_T2': 20, # after
                            'snippet_mask_radius': None,
                            'npca_per_branch': 3,
                            'snippet_mask_radius': 250,
                            'scheme1_detect_channel_radius': None, #150, # the length around the channel with highest waveform amp to apply detect_time_radius_msec (None = applied infinitly so all channel are bloked -> bad; except if sorted by group)
    ...
    'hdsort' : "hdsort_output",
    
    'tridesclous' : "tridesclous_output",
    
    'waveclus' : "waveclus_output",
    
    'spykingcircus' : "spykingcircus_output",
    ...
    'spykingcircus2' : {'surname' : "SC2",
                        ...
                        'exctractor' : si.read_npz_sorting, #se.SpykingCircusSortingExtractor # NpzSortingExtractor (might be this one instead)
                        # or that one : si.read_npz_sorting
    ...
    'tridesclous2' : {'surname' : "TDC2",
                        ...
                        'exctractor' : se.TridesclousSortingExtractor
                        }    
    }